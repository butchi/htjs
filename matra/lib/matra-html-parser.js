...
function peg$parse(input, options) {
  ...
  var peg$f2 = function(prop, body) {
    return { tag: null, prop, body }
  };
  var peg$f3 = function(prop, body) {
    return { tag: null, prop, body }
  };
  ...
  var peg$f8 = function(arr) {
    return arr
  };
  var peg$f9 = function(arr) {
    return arr.map(item => item[0])
  };
  var peg$f10 = function(key, val) {
    return ({ rule: "map", key, val })
  };
  var peg$f11 = function(key, val) {
    return ({ rule: "set", key, val })
  };
  var peg$f12 = function(key, val) {
